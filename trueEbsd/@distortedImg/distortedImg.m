...
%   disImg = distortedImg(img,distortionName,"dxy",[dx dy]);
...
properties %properties we import from the constructor function
  ...
  how2plot = plottingConvention(-vector3d.Z,vector3d.X) % defaults to 'axis image'
...
methods
  ...
  function disImg = distortedImg(img,distortionName,varargin)
    ...
    if ~isempty(disImg.ebsd)
      disImg.how2plot = disImg.ebsd.how2plot;
    ...
    disImg.how2plot  = getClass(varargin,'plottingConvention',disImg.how2plot);
